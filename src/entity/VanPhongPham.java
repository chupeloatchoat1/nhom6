...
public class VanPhongPham extends SanPham{
	...
	public VanPhongPham(String maSanPham, int soLuongTon, NhaCungCap nhaCungCap, long giaNhap, String ghiChu,
			double trongLuong, String donViSanPham, String hinhAnh, String tenVanPhongPham,
